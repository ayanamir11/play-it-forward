    ...
    <>
      ...
      <div
        className={[
          ...
          "lg:left-auto lg:top-0 lg:right-0 lg:bottom-0 lg:w-[360px] lg:translate-y-0",
          // Mobile open/closed
          isOpen ? "translate-y-0" : "translate-y-full lg:translate-x-0",
          // Desktop open/closed
        ...
        style={{
          ...
          maxHeight: "85vh",
          // Desktop: full height, no maxHeight cap
        }}
      >
